...
FS.LIBoard = {
  onloadFunction: function() {
        ...
        //MobileCRM.bridge.alert("onload function");
  ...
  refreshDataOnly: function() {
    ...
    getUserForemans: function () {
        //MobileCRM.bridge.alert("gettingg userforemans");
    var fetchData = {
  ...
  buildTable: function(itemArray) {
   ...
   var months = [
    ...
    for (var i in itemArray) {
        ...
        //MobileCRM.bridge.alert(itemArray[i]);
      var linemessage = "<br/>";
    ...
    getForeman: function () {
        MobileCRM.bridge.alert("get foreman function")
    var fetchForemanXML =
  ...
  getAllLIs: function() {
    ...
    var fetchLIXml = [
      "<fetch resultformat='DynamicEntities' version='1.0' aggregate='false'>",
        ...
        fetchData.iroc_vehicleinspectionstatus /*929530001*/,
        "'/>",
        "<condition attribute='iroc_vehicleinspectionstatus' operator = 'eq' value='",
        fetchData.iroc_vehicleinspectionstatus2 /*929530000*/,
        "'/>",
        "<condition attribute='iroc_vehicleinspectionstatus' operator = 'eq' value='",
        fetchData.iroc_vehicleinspectionstatus3 /*929530002*/,
        "'/>",
        "</filter>",
        "<link-entity name='iroc_vehicle' to = 'iroc_vehicleid' from='iroc_vehicleid' alias='pad'>",
        "<attribute name='iroc_foremangroup' />",
        "    </link-entity>",
        "  </entity>",
      "</fetch>"
    ...
    MobileCRM.FetchXml.Fetch.executeFromXML(
      ...
      function(defaultlirecords) {
        ...
        for (var i in defaultlirecords) {
          ...
          var newItem = new Object();
            newItem.LIID = lirecords["iroc_vehicleinspectionid"];
            newItem.LIName = lirecords["iroc_name"];
            newItem.LIStatusName = lirecords["iroc_vehicleinspectionstatusname"];
            newItem.LIStatus = lirecords["iroc_vehicleinspectionstatus"];
          ...
          newItem.CreatedOn = lirecords["createdon"];
            newItem.CompletedOn = lirecords["iroc_completedinspectiondate"];
          newItem.CompletedBy =
              lirecords["iroc_completedbyname"] === undefined
              ? "unknown"
              : lirecords["iroc_completedbyname"];
